...
import com.study.umc_android_chapter6.databinding.FragmentOneBinding
...
class OneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        data.add(Post("최근 쓴 글들을 보여주는 곳이에요.", "예시라서 for문으로 떼웠지만..., 다음에는 tabView를 더 다듬고 싶네요.", R.drawable.ad_image))
        for(i in 0..20){
